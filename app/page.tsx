        ...
        <aside className="col-span-12 border-r border-zinc-900 px-4 py-6 md:col-span-3 md:min-h-[calc(100vh-3rem)]">
          ...
          <ul className="space-y-px">
            {typeKeys.map((k) => {
              ...
              return (
                <li key={k}>
                  <div className="flex items-center justify-between rounded px-2 py-1.5 text-sm hover:bg-zinc-900/60">
            ...
            {typeKeys.length === 0 ? (
              <li className="px-2 py-3 text-xs text-zinc-500">
                No types yet. Open the chat and propose one.
              </li>
            ) : null}
          </ul>
          ...
          {pending.length > 0 ? (
            ...
            <div className="rounded-md border border-dashed border-zinc-800 bg-zinc-900/20 px-6 py-10">
              ...
              <p className="mt-5 text-xs text-zinc-500">
                Paste one into the chat on the right. The agent will propose a
